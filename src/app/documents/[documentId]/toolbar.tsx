...
import { BoldIcon, ChevronDownIcon, HighlighterIcon, ItalicIcon, ListTodoIcon, LucideIcon, MessageSquarePlusIcon, PrinterIcon, Redo2Icon, RemoveFormattingIcon, SmileIcon, SpellCheckIcon, UnderlineIcon, Undo2Icon } from 'lucide-react';
...
const HighlightColorButton = () => {
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent className='p-1.5 z-[100]'>
